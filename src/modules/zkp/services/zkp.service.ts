...
export class ZkpService {
  ...
  private readonly contractAddress = '0xf1AdF8eD7569e0BceC73B371f4876Db69515CD20';
  ...
  constructor() {
    ...
    this.wallet = new ethers.Wallet('812c3d58559a4d5e914d478599e26bd684e6f4e191ab989e26466a41945e99e7', this.provider);
  ...
  async zpkProof(proofString: string): Promise<boolean> {
    try {
      ...
      const result = await this.contract.verifyProof(proofSlices[0], [proofSlices[1], proofSlices[2]], proofSlices[3], proofSlices[4]);
      return result;
    } catch (error) {
